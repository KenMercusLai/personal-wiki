...
type: concept
tags: [learning, writing, research]
sources:
...
## Definition
[[LearningByWriting]] is a writing-centered investigation method in which the learner forms a provisional view early, writes and defends it, identifies weaknesses, researches the most view-changing subquestions, revises or switches sides, and repeats.

## Current Synthesis
The source presents learning by writing as an alternative to reading broadly until one feels qualified to have an opinion. The method deliberately creates a premature bottom-line hypothesis because that hypothesis makes the research problem concrete: it reveals what the learner is actually claiming, which assumptions are weakest, and which subquestions would most change the conclusion. Reading remains important, but it is selected and sequenced by the argument under construction.
...
- Early hypothesis: [[blog-holden-karnofsky-cold-takes-learning-by-writing]] recommends explaining and defending a premature hypothesis after a small amount of reading or discussion.
- Weakness and revision loop: [[blog-holden-karnofsky-cold-takes-learning-by-writing]] repeatedly moves from written claim to weakness list, targeted reading, revised claim, and possible side switch.
- Subquestion selection: [[blog-holden-karnofsky-cold-takes-learning-by-writing]] argues that writing the main claim helps decide which subdebates are worth deeper research.
...
- [[FocusedReading]] - the current claim and its weak points determine what to read next.
- [[KnowledgeOutput]] - drafts are intermediate learning artifacts as well as possible public outputs.
- [[ExplanatoryWriting]] - later drafts need feedback and clarity for readers.
- [[SystematicLearning]] - learning by writing offers a complementary route to building usable understanding without reading every subdebate first.
- [[SpeedReadingMethod]] - selective deep reading can culminate in written output that makes understanding durable.
