...
## Definition
[[AdaptivePersistence]] is sustained commitment expressed through repeated improvement, recovery after setbacks, and willingness to abandon a wrong direction without abandoning the larger effort.

## Current Synthesis
The source presents [[SamWalton]]'s persistence as active correction rather than passive endurance. He experimented within a franchise model, accepted responsibility for a lease mistake that destroyed his first successful store, rebuilt in a smaller town, recovered from a tornado, absorbed a failed shopping-mall bet, and kept changing direction when evidence showed he was wrong. The repeating unit was not one idea but a daily determination to improve something.
...
- [[FailureOwnership]] - responsibility turns setbacks into correctable decisions without requiring fixed self-condemnation.
