...
媒介应匹配认知任务：视频适合动态示范，文本适合精确引用与非线性复查，问答适合局部疑点，可导航知识库适合长期组织。媒介没有脱离内容质量、任务和学习者条件的绝对排名。

理解程度可用[解释驱动学习循环]({{< relref "/wiki/concepts/explanation-driven-learning-loop.md" >}})检验，而不只看阅读量。
