...
## Definition
[[ProductMarketFit]] is the point at which a startup has enough evidence that a real market wants its product to justify shifting from discovery and manual learning toward growth, hiring, revenue scaling, and organization-building. Definitions in the corpus span a range: at the loosest, retention or transactions that justify scaling; at the strictest, demand that already outruns the team's capacity to serve it; and, in [[StevenSinofsky]]'s marketing-mix version, the complete commercial arrangement of product, price, place, and promotion.
...
- Customer love: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[BrianChesky]]'s lesson that 100 people who love the product matter more than one million who merely like it.
- Post-fit CEO priorities: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] says Chesky focused on hiring, strategy, and culture after product-market fit.
- Growth expansion: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[MariamNaficy]] on revenue scaling and new verticals or geographies after fit.
- Failed-fit case: [[4-lessons-from-a-failed-startup-from-and-for-first-time-founders]] says [[Maderight]] joined [[YCombinator]] and [[StartX]], raised venture funding, operated for three years, and still shut down without product-market fit.
- Pre-fit sales learning: [[4-lessons-from-a-failed-startup-from-and-for-first-time-founders]] argues sales before fit is about customer conversations, problem identification, and solution testing, with revenue as a byproduct.
- Service/product ambiguity: [[4-lessons-from-a-failed-startup-from-and-for-first-time-founders]] says Maderight's existing service customers wanted high-touch work while new customers adopted the product, splitting focus.
...
- Fit metric choice: [[building-products-the-year-of-the-looking-glass-medium]] recommends retention over engagement or raw user count when a team is deciding whether it has product-market fit.
- Problem-first framing: [[building-products-the-year-of-the-looking-glass-medium]] says product work should begin with a clear problem, audience, and reason the problem is worth solving.
- Transaction evidence: [[classpass-founder-on-how-marketplace-startups-can-achieve-product-market-fit-first-round-review]] says early Classtivity had press and funding but no reservations, while Passport generated 20,000 reservations in six months.
- Marketplace fit metric: [[classpass-founder-on-how-marketplace-startups-can-achieve-product-market-fit-first-round-review]] says [[ClassPass]] chose reservations per person as the metric that connected habit formation, churn, revenue, studio value, and mission impact.
- Behavior-change pivot: [[classpass-founder-on-how-marketplace-startups-can-achieve-product-market-fit-first-round-review]] says users' repeated Passport signups revealed stronger demand for class variety than for one-time studio sampling.
- Capacity-overwhelm definition: [[y-combinator-ceo-if-you-are-not-drowning-in-demand-you-dont-have-product-market-fit-capital-growth-blog]] defines fit as drowning in demand — more customers using the product than the team can handle — and says a company without that does not have fit.
- Loose usage warning: [[y-combinator-ceo-if-you-are-not-drowning-in-demand-you-dont-have-product-market-fit-capital-growth-blog]] argues most people use the term product-market fit too loosely.
- Presumed-fit failure: [[y-combinator-ceo-if-you-are-not-drowning-in-demand-you-dont-have-product-market-fit-capital-growth-blog]] names thinking fit has been attained, then scaling and raising expenses, as the major cause of failure for YC companies.

Execution as the whole commercial arrangement:
- [[yesterdays-failures-are-todays-successes-learning-by-shipping]] defines execution as the complete set of product, price, place, and promotion and equates it with product-market fit.
...
The four-P framing is a managerial definition rather than a measured threshold: it says what fit has to include without saying how a team would recognize that it has been reached, and its author's own enabler list is a 2016 retrospective built from ideas that later succeeded. It also sits awkwardly beside the stricter cases on this page, because a complete product, price, place, and promotion arrangement may still fall short of overwhelmed demand, retention, or transactions per person, which the essay does not attempt to reconcile.
...
- [[DoingThingsThatDoNotScale]] - manual work can help teams discover whether users truly love the product.
- [[StartupScaling]] - product-market fit changes what scaling problems matter.
- [[Blitzscaling]] - fast scaling should wait until there is evidence the company is ready.
...
- [[UserBehaviorDrivenProductDiscovery]] - unexpected behavior can reveal the product value that users actually want.
