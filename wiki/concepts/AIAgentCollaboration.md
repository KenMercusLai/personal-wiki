...
At project scale, collaboration can be mediated through durable documents rather than one chat: PM, Architect, Engineer, and QA agents collaborate by writing and consuming roadmaps, gap analyses, ADRs, specs, test plans, and CI status files.
...
- Multi-agent collaboration works best when each role owns clear artifacts and follows an explicit decision hierarchy.
