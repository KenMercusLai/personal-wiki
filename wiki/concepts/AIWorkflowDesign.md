...
## Definition
[[AIWorkflowDesign]] is the practice of turning AI use into traceable, controllable, verifiable sequences of tasks, materials, standards, and review loops instead of relying on one-shot prompts for finished answers.

## Current Synthesis
The source frames AI workflow design as the practical alternative to magical prompt thinking. For humanities workers, writers, editors, and researchers, the core move is to describe the work well enough that AI can perform bounded steps: identify audience and purpose, structure a task, process clean source material, extract facts, group stories, propose variants, and support revision. The goal is not to remove the human but to make the human's intent visible throughout the process, so the final work remains material-grounded and signable.
...
## Evidence
- Process standard: [[gei-ren-wen-gong-zuo-zhe-de-ai-shi-yong-zhi-nan]] sets traceability, supervision, verification, controllability, and willingness to sign as the guide's baseline.
- Task specification: [[gei-ren-wen-gong-zuo-zhe-de-ai-shi-yong-zhi-nan]] contrasts vague requests with assignments that specify audience, explanation style, structure, tone, background, and evaluation standards.
- Model management: [[gei-ren-wen-gong-zuo-zhe-de-ai-shi-yong-zhi-nan]] recommends asking multiple AI systems the same question to learn their different strengths and failure modes.
- Pipeline design: [[gei-ren-wen-gong-zuo-zhe-de-ai-shi-yong-zhi-nan]] describes decomposing a nonfiction-writing process into many steps, and the screenshot shows a sequence from fact extraction through story-bank merging, grouping, layout, ordering, and AB testing.
...
- [[LLMContextManagement]] - context preparation and compression are workflow-design levers.
