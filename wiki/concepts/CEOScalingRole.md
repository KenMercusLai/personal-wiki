...
## Evidence
- Managing chaos: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[EricSchmidt]] on organizing the world around fast product and engineering talent.
- Core CEO jobs: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[PatrickCollison]] on strategy, culture, senior management, and optional product ownership.
- Coaching: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[JeffWeiner]] on coaching people to solve problems instead of founder problem-solving.
- Path clearing: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[MarissaMayer]] on CEOs setting direction, defending the team, and removing blockers.
- Stage evolution: [[16-lessons-on-scaling-from-eric-schmidt-reid-hoffman-marissa-mayer-brian-chesky-diane-greene-jeff-weiner-and-more]] cites [[ReedHastings]] on moving from doing everything to vision, focus, inspiration, and culture.
- Senior-hiring process: [[assembling-an-executive-leadership-team-is-daunting-let-thumbtacks-ceo-help-first-round-review]] presents [[MarcoZappacosta]] learning to build [[Thumbtack]]'s executive team through focused role definitions, references, fit interviews, and 360-degree feedback exchange.
- Direct-report relief: [[bring-in-the-adults-8vc-news-medium]] says senior hires help manage growing teams, maintain detail, define KPIs, and enable the CEO by reducing the number of direct reports.
- Timing risk: [[bring-in-the-adults-8vc-news-medium]] warns that bringing experienced operators in too early can obstruct innovation, while waiting too long can leave scaling functions late.
- Early CEO communication: [[ceo-advice-from-a-new-ceo-the-biz-stone-collection-medium]] says missing knowledge creates fear and that CEOs should communicate often even in small companies.
...
- [[Blitzscaling]] - rapid growth increases the CEO's chaos-management burden.
- [[ScalingCommunication]] - CEOs must create repeated alignment as context fragments.
