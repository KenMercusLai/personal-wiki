...
title: "Viral Loops"
type: concept
tags: [marketing, product-growth, network-effects]
sources:
...
## Definition
[[ViralLoops]] are acquisition mechanisms in which a user's normal action, invitation, share, embed, message, artifact, or visible product use exposes non-users to the product and gives them a reason to join, click, consider, or return.
...
- Public web and status surfaces: [[51-examples-of-growth-hacking-strategies-techniques-from-the-worlds-most-innovative-businesses]] says [[LinkedIn]] public profiles made members discoverable through search, while [[9-ways-to-build-virality-into-your-product-gabor-cselle-medium]] describes [[Twitter]] follower counts and LinkedIn connection counts as vanity loops.
- Referral and collaboration loops: [[9-ways-to-build-virality-into-your-product-gabor-cselle-medium]] uses [[Dropbox]], [[GoodEggs]], [[Slack]], [[GoogleDocs]], and [[Airtable]] to show incentives and collaboration as built-in invitation surfaces.
- Two-sided invite discipline: [[being-a-product-manager-how-to-get-your-products-built]] uses [[Uber]]'s give/get ride-credit model to argue that both inviter and invitee need real value, and that weak products should not push invite loops.
...
- [[SocialProof]] - visible usage and public artifacts can signal desirability.
