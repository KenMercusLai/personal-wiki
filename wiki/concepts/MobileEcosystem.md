...
- Ecosystem shifts can defeat incumbents through different mechanisms: delayed platform replacement, too-late modernization, premature transition signaling, or broken licensing economics.
...
- Incumbent disruption: [[blackberry-meditation-at-the-grave-jean-louis-gassee-medium]] distinguishes BlackBerry's delayed [[QNX]] response, Palm's late [[WebOS]] response, Nokia's [[OsborneEffect]], and Microsoft's [[PlatformBusinessModelObstacle]].
- App framework gap: [[blackberry-meditation-at-the-grave-jean-louis-gassee-medium]] argues that replacing an operating system was not enough because successful smartphone platforms also needed application frameworks and ecosystems.
...
The Evans source is a 2015 strategic thesis rather than a measured forecast review. It does not prove how much PC work will move to mobile, nor does it account for later cloud, AI, regulatory, or enterprise changes except as future themes. The BlackBerry source is a 2016 retrospective essay and separates failure modes persuasively, but it does not fully settle every disputed cause of BlackBerry, Palm, Nokia, Windows Phone, or Microsoft's broader mobile strategy. The App Annie/VentureBeat source is a 2015 app-store snapshot and should not be treated as current download or revenue data. The Asymco and Above Avalon sources are Apple-focused analyst interpretations based on estimates and product-strategy inference, so they support the satellite-to-independence and post-iPhone-seeding patterns without proving later market outcomes.

## What Changed
- Added incumbent failure modes from the smartphone transition: delayed platform replacement, late modernization, premature transition signaling, and business-model mismatch.
...
- [[SmartphonePlatformDisruption]] - iOS and Android displaced older handset strategies by changing platform requirements.
- [[OsborneEffect]] - premature ecosystem-transition signaling can damage current-product demand.
- [[PlatformBusinessModelObstacle]] - platform competition can break older licensing economics.
