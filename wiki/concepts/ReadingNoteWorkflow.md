...
- Domain fit: [[ka-pian-bi-ji-shi-cao-pian-tui-li-xiao-shuo-yu-du-shu-bi-ji-yi-obsidian-wei-li]] says finding a suitable domain for card notes can matter more than studying the method abstractly.
- Entry notes: [[ka-pian-bi-ji-shi-cao-pian-tui-li-xiao-shuo-yu-du-shu-bi-ji-yi-obsidian-wei-li]] recommends book metadata, genre labels, summaries, background, influences, and mystery tricks as relationship-rich entry-note material.
- Outline notes: [[ka-pian-bi-ji-shi-cao-pian-tui-li-xiao-shuo-yu-du-shu-bi-ji-yi-obsidian-wei-li]] describes author chronologies, genre lists, award histories, and personal reading records as outline-note use cases.
...
- [[PersonalKnowledgeManagement]] - reading notes become reusable material inside a personal knowledge base.
- [[NoteGranularity]] - different reading tasks call for different note sizes and structures.
- [[NoteToolFit]] - reading-note workflows benefit from backlinks, graph views, filtering, and folding features.
- [[KnowledgeOutput]] - summaries, opinions, and reviews turn reading into output.
- [[AcademicResearchWorkflow]] - integrates source-linked literature notes into a citation-aware manuscript pipeline.
- [[Zotero]] - supplies metadata and annotations for automated per-reference notes.
