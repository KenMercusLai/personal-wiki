...
title: "Second Brain"
type: concept
tags: [knowledge-management, note-taking, ai]
sources:
...
- Its value depends on retrieval at the moment the material becomes relevant.
...
- Retrieval problem: [[feynman-technique-in-practice-indigo-information-acquisition-knowledge-output-methodology]] says notes matter because a quote, meeting note, or idea may later serve many different uses.
...
- [[AIKnowledgeAssistant]] - the assistant is the mechanism the source expects to make the second brain more active.
- [[KnowledgeOutput]] - second-brain retrieval supplies material for future writing, teaching, and decisions.
- [[FocusedReading]] - focused reading contributes organized material to the external knowledge system.
- [[PrivateDataChatbot]] - document chat is one interface for querying a second brain.
- [[RetrievalAugmentedGeneration]] - RAG supplies a technical pattern for second-brain retrieval.
