...
type: entity
tags: [publication, product-management]
sources:
...
## Evidence
- Publication context: [[7-lessons-on-building-product-with-outsourced-developers-mind-the-product]] is titled as a Mind the Product article and presents lessons for product managers.
- Outsourcing guidance: [[7-lessons-on-building-product-with-outsourced-developers-mind-the-product]] gives seven lessons on references, fit tests, critical scope, workflow adaptation, QA, technical detail, and project tracking.
...
- [[MinimumViableProduct]] - the article presents outsourced prototypes as one possible MVP validation path.
- [[CustomerLedProductDevelopment]] - the article's advice focuses external work on critical product functionality and learning.
