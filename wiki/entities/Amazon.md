...
- Timeless customer desires: [[betting-on-things-that-never-change-collaborative-fund]] says Amazon's early promise of one million titles and consistently low prices reflected old retail values rather than only Internet novelty.
- Bezos strategy frame: [[betting-on-things-that-never-change-collaborative-fund]] quotes [[JeffBezos]] arguing that low prices, fast delivery, and vast selection were safe long-term areas for Amazon to invest energy.
- Capability-led expansion: [[bezos-unbound-exclusive-interview-with-the-amazon-founder-on-what-he-plans-to-conquer-next]] says Amazon reused book-retail capabilities to expand into other categories, sellers, Mechanical Turk, Fulfillment by Amazon, Amazon Pay, AWS, Kindle, Echo, Prime, and Amazon Go.
...
- [[Google]] - another giant in the source's software, cash, and data comparison.
...
- [[WebCentralization]] - Staltz frames Amazon as one of the three dominant networks pressuring independent Web activity.
