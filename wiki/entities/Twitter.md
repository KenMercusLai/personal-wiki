...
## Overview
[[Twitter]] is a social platform used in the wiki as a growth case for public status signals and staged onboarding, a troubled cultural platform, a personal information tool whose value depends heavily on defaults, curation, safety, and user control, and an early infrastructure-failure case where demand survived repeated outages.
...
## Key Characteristics
- Social platform shaped by public conversation, influential accounts, and verified-account status signals.
- Benefits from celebrity, political, and media participation, with public follower counts acting as a vanity and competition surface.
...
## Qualifications
The sources predate later changes in Twitter's ownership, verification policies, platform name, API posture, and social-media competition. Their claims should be read as historical interpretations of earlier Twitter growth, onboarding, engagement, and reliability dynamics, a 2016-2017 outside critique, and a 2022 power-user workflow, not as a current audit of X/Twitter.

## What Changed
- Added Fowler's power-user workflow: Twitter as curated discovery through selective follows, lists, chronology, and read-later handoff.
- Strengthened the qualification that Twitter's usefulness can coexist with low-value conversations and unresolved harassment risk.
- Added the fail whale era as evidence that early infrastructure failure can coexist with strong user pull.
- Added Elman's ladder of engagement as a historical model for Twitter onboarding and deeper participation.
