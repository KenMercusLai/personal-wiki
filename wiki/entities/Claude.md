...
## Overview
[[Claude]] is the AI assistant family used in these sources as a software-engineering agent, as the model family behind [[ClaudeCode]], and as an example model in LLM-assisted statistical-analysis workflows.
