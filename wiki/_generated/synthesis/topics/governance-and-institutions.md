...
input_digest: 0c54ea64cd653146f67fce4bf0a07deee2d9e29de30dc41d14f81e1ffabfc9a1
---
...
### Browser Mining Consent Needs Layered Enforcement

[[BrowserCryptomining]] shows consent as a layered governance problem: [[CoinHive]] could recommend disclosure without preventing covert deployment, so operator notice, user choice, [[AdGuard]] controls, and [[Cloudflare]] service sanctions provided distinct policy and enforcement boundaries.

**Evidence:** [[BrowserCryptomining]], [[CoinHive]], [[AdGuard]], [[Cloudflare]]

**Qualifications:**

- The enforcement account comes from one AdGuard-authored 2017 article and does not identify Cloudflare's affected accounts, policy text, appeal process, consistency, or outcomes.
- No session-level evidence establishes how many users knowingly consented, refused, or were exposed.
